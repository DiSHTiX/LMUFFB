...
5.  **In-Game Force Feedback settings in LMU**:
    *   In-game Force Feedback can be left **Enabled**.
    *   It is necessary to have it enabled if you want to use the option to also transmit the in-game FFB through the lmuFFB app.
