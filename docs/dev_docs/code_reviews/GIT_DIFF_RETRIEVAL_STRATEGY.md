...
You can read the prompt with the instructions that were given to the coding agent at `docs\dev_docs\prompts\v_0.5.14.md`, `docs\dev_docs\prompts\v_0.5.14_pt2.md` and `docs\dev_docs\prompts\v_0.5.14_pt3.md`. Read this document to understand what was supposed to be implemented and verify that the staged changes fullfilled all requirements.
