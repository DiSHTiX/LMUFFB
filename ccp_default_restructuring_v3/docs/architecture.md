...
*   **Main/GUI Thread (Low Priority)**:
    ...
    *   Handles User Interface (Dear ImGui), window management, and input processing.
    *   Implements "Lazy Rendering": If the window is minimized or not focused, the update rate drops to save CPU cycles.
